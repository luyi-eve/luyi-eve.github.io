...
import {
  ...
  safe_not_equal,
  validate_slots
} from "./chunk-BAUWJ7JV.js";
import "./chunk-2GBBIY5G.js";
import "./chunk-4DX7OK5R.js";
...
function createUserPrefersMode() {
  ...
  const initialValue = storage.getItem(getModeStorageKey2());
  let value = isValidMode(initialValue) ? initialValue : defaultValue;
  function getModeStorageKey2() {
  ...
  function set(v) {
    ...
    if (typeof window !== "undefined") {
      localStorage.setItem(getModeStorageKey2(), "light");
...
function createCustomTheme() {
  const storage = isBrowser ? localStorage : noopStorage;
  const initialValue = storage.getItem(getThemeStorageKey2());
  let value = initialValue === null || initialValue === void 0 ? "" : initialValue;
  function getThemeStorageKey2() {
  ...
  function set(v) {
    _set(value = v);
    storage.setItem(getThemeStorageKey2(), value);
  }
  return {
    subscribe,
    set
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[0].dark);
      add_location(meta, file, 72, 2, 2130);
    },
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      append_hydration_dev(document_1.head, if_block0_anchor);
